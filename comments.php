...
<?php if ( isset( $pod_comm_display ) && $pod_comm_display == true ) : ?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php printf( _n( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number()),
	...
	?>
		<p class="nocomments"><?php _e( '', 'thstlang' ); ?></p>
	<?php endif; ?>
</div><!-- #comments -->
<?php else : ?>
	<div class="closed-comments">
		<?php if ( ! is_page() ) : ?>
		<?php echo __('', 'thstlang'); ?>
		<?php endif; ?>
	</div>
<?php endif; ?>